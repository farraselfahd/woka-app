					...
					<div class="box">
						...
						<div class="row mt-4">
							<p style="text-align: center;">
								<img src="{{asset('img/')}}/il_1140xN.1623396501_6860.jpg" width="100px" alt="">
								<img src="{{asset('img/')}}/elephant-head-bronzed-wood-wall-art-600x600.jpg" width="100px" alt="">
								<img src="{{asset('img/')}}/painted-green-family-tree-wooden-wall-hanging-600x601.jpg"  width="100px" alt="">
								<img src="{{asset('img/')}}/wedding-sign-wooden-wall-signs-600x450.jpg" width="135px" alt="">
							</p>
						</div>
					</div>
				</div>
