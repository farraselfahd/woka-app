	...
	<div class="container">
		<div class="row mt-5">
			<div class="col-lg col-sm-12 flex">
				...
				<img src="{{ asset('img/') }}/20191122_01.png" class="card-img-top" alt="..." data-bs-toggle="modal" data-bs-target="#exampleModal" style="cursor: pointer;">
									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-lg-8 col-sm-12 thumb-post">
												<img src="{{ asset('img/') }}/20191122_01.png" class="rounded" width="100%" alt="">
											</div>
			...
			<div class="col-lg col-sm-12 flex">
				<div class="card" style="width: 18rem;">
					<img src="{{ asset('img/') }}/Chainsaw-Wood-Cutting-Tools.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-3">
								<img src="{{ asset('img/') }}/profile.PNG" class="rounded-circle" width="50px" alt="">
			...
			<div class="col-lg col-sm-12 flex">
				<div class="card" style="width: 18rem;">
					<img src="{{ asset('img/') }}/lathe-wood-082318-Copy-min.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-3">
								<img src="{{ asset('img/') }}/profile.PNG" class="rounded-circle" width="50px" alt="">
		...
		<div class="row mt-5">
			<div class="col-lg col-sm-12 flex">
				<div class="card" style="width: 18rem;">
					<img src="{{ asset('img/') }}/carpenter-lead-image-082318-min.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-3">
								<img src="{{ asset('img/') }}/profile.PNG" class="rounded-circle" width="50px" alt="">
			...
			<div class="col-lg col-sm-12 flex">
				<div class="card" style="width: 18rem;">
					<img src="{{ asset('img/') }}/Ax-Wood-Cutting-Tools.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-3">
								<img src="{{ asset('img/') }}/profile.PNG" class="rounded-circle" width="50px" alt="">
			...
			<div class="col-lg col-sm-12 flex">
				<div class="card" style="width: 18rem;">
					<img src="{{ asset('img/') }}/IMG_1378.JPG" class="card-img-top" alt="...">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-3">
								<img src="{{ asset('img/') }}/profile.PNG" class="rounded-circle" width="50px" alt="">
