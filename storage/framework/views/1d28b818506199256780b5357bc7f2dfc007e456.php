					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div>
								<form method="post">
                                    <?php echo csrf_field(); ?>
									<button type="submit" formaction="<?php echo e(url('order/done')); ?>" class="btn btn-pesan mt-3 flex">Konfirmasi & Bayar</button>
								</form>
...
</html><?php /**PATH C:\xampp\htdocs\woka-app - Copy\resources\views/pesan/bayar.blade.php ENDPATH**/ ?>