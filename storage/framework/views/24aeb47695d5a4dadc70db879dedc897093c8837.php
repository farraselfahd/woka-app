...
<div class="row bottom mt-5 flex">
	...
	<div class="row top bottom">
		<a class="btn btn-home flex" href="/">Halaman Utama</a>
	</div>
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\woka-app\resources\views/gabung/4.blade.php ENDPATH**/ ?>