			...
			<div class="col-lg-7 col-sm-12">
				<div class="card mt-4 d-flex align-items-center justify-content-center">
					<div class="card-body">
						...
						<div class="mt-5 mb-5">
							<form>
								<button type="submit" formaction="<?php echo e(url('/profil')); ?>" class="btn btn-pesan mt-3 flex">Lihat Pesanan</button>
							</form>
						</div>
					</div>
				</div>
...
</html><?php /**PATH C:\xampp\htdocs\woka-app - Copy\resources\views/pesan/selesai.blade.php ENDPATH**/ ?>