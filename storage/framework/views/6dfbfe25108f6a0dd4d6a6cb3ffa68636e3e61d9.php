...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('css/')); ?>/jelajahi.css">
	...
	<div class="container mt-5">
		...
		<div class="row top">
			...
			<div class="col-lg col-sm-12">
				<img src="<?php echo e(asset('img/')); ?>/cari.PNG" alt="" class="rounded float-end">
			</div>
		</div>

		<div class="row top">
			<div class="col-lg col-sm-12">
				<img src="<?php echo e(asset('img/')); ?>/cari.PNG" alt="" class="rounded">
			</div>
			<div class="col-lg col-sm-12 flex">
				<p>
					<span style="font-size: 30px; font-weight: bold;">2. Pesan</span>
					<br>
					Setelah menemukan jasa yang sesuai, <br> anda bisa langsung memilih rincian jasa, <br> atau bernegosiasi dengan penyedia jasa.				</p>
				</p>
			</div>
		</div>
		...
		<div class="row top">
			<div class="col-lg col-sm-12 flex">
				<p>
					...
					<br>
					Checkout dan tunggu konfirmai dari penyedia jasa. Setelah diproses jasa yang anda butuhkan akan segera dikerjakan.	
				</p>
			</div>
			<div class="col-lg col-sm-12">
				<img src="<?php echo e(asset('img/')); ?>/cari.PNG" alt="" class="rounded float-end">
		...
		<div class="row top bottom">
			<div class="card-clr">
				<h3>
					Sudah Siap Memesan?
					<br>
					<button type="button" class="btn btn-outline-dark mt-4">Pesan Sekarang</button>
				</h3>
			</div>
		</div>
...
</html><?php /**PATH C:\xampp\htdocs\woka-app - Copy\resources\views/jelajahi.blade.php ENDPATH**/ ?>