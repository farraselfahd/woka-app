	...
	<div class="row mt-4 bottom form-set">
        ...
        <?php echo csrf_field(); ?>
			...
			<div class="row mt-4">
				...
				<div class="col-lg col-sm-12">
					<input type="text" class="form-control" placeholder="Masukan Pertanyaan">
				</div>
				<div class="col-lg col-sm-12">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\woka-app\resources\views/gabung/3.blade.php ENDPATH**/ ?>