...
<div class="row mt-4 bottom form-set">
        ...
        <?php echo csrf_field(); ?>
			<div class="row mt-4">
				...
				<div class="col-lg col-sm-12">
					<input type="text" class="form-control" placeholder="No Identitas" name="no_identitas" value="<?php echo e(old('no_identitas')); ?>">
...
unset($__errorArgs, $__bag); ?> -->
			...
			<div class="row mt-4">
				...
				<div class="col-lg col-sm-12">
					<input class="form-check-input" type="radio" name="jenis_kelamin"> Pria &emsp;
					<input class="form-check-input" type="radio" name="jenis_kelamin"> Wanita
				</div>
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\woka-app - Copy\resources\views/gabung/info.blade.php ENDPATH**/ ?>